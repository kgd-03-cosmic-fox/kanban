...
exports.default = _default;
        var $6e53ea = exports.default || module.exports;
      
      if (typeof $6e53ea === 'function') {
        $6e53ea = $6e53ea.options;
      }
    
        /* template */
        Object.assign($6e53ea, (function () {
          var render = function() {
  var _vm = this
...
var staticRenderFns = [
  function() {
    ...
    return _c("a", { staticClass: "navbar-brand", attrs: { href: "#" } }, [
      _c("img", {
        attrs: {
          src: "/caneband-logo.7389ef12.png",
          alt: "",
          width: "75px"
        }
      })
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$6e53ea', $6e53ea);
          } else {
            api.reload('$6e53ea', $6e53ea);
          }
        }
...
},{"./..\\assets\\img\\caneband-logo.png":[["caneband-logo.7389ef12.png","src/assets/img/caneband-logo.png"],"src/assets/img/caneband-logo.png"],"_css_loader":"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/LoginPage.vue":[function(require,module,exports) {
"use strict";
  ...
  methods: {
    login: function login() {
      ...
      axios({
        ...
        _this.user.name = response.data.payload.name;
        localStorage.setItem("access_token", response.data.token);

        _this.$emit('changePage', "main-page");
...
exports.default = _default;
        var $be74b4 = exports.default || module.exports;
      
      if (typeof $be74b4 === 'function') {
        $be74b4 = $be74b4.options;
      }
    
        /* template */
        Object.assign($be74b4, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "border-solid rounded border border-dark" }, [
    _c(
      "form",
      {
        staticClass: "flex-login h80",
        on: {
      ...
      [
        _c("input", {
          ...
          staticClass: "mb-4",
          attrs: { type: "text", id: "email-input", placeholder: "email" },
        ...
        _vm._v(" "),
        _c("button", { staticClass: "mb-4 btn btn-primary" }, [
          _vm._v("Login")
        ]),
        _vm._v(" "),
        _c("img", {
    ...
    _c(
      "button",
      { staticClass: "btn btn-secondary", on: { click: _vm.registerPage } },
      [_vm._v("Register")]
    )
  ])
}
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$be74b4', $be74b4);
          } else {
            api.reload('$be74b4', $be74b4);
          }
        }
  ...
  method: {
    register: function register() {
      ...
      (0, _axios.default)({
        ...
        _this.$emit('changePage', 'login-page');
      }).catch(function (err) {
        console.log(err);
      });
    },
...
exports.default = _default;
        var $ce8b65 = exports.default || module.exports;
      
      if (typeof $ce8b65 === 'function') {
        $ce8b65 = $ce8b65.options;
      }
    
        /* template */
        Object.assign($ce8b65, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.newUser.OrganizationId,
                expression: "newUser.OrganizationId"
              }
            ],
            on: {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$ce8b65', $ce8b65);
          } else {
            api.reload('$ce8b65', $ce8b65);
          }
        }
...
},{"axios":"node_modules/axios/index.js","_css_loader":"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/KanbanCard.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
      ...
      if (typeof $695c04 === 'function') {
        $695c04 = $695c04.options;
      }
    
        /* template */
        Object.assign($695c04, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$695c04', $695c04);
          } else {
            api.reload('$695c04', $695c04);
          }
        }
...
},{"_css_loader":"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/KanbanBoard.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
      ...
      if (typeof $2e929f === 'function') {
        $2e929f = $2e929f.options;
      }
    
        /* template */
        Object.assign($2e929f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$2e929f', $2e929f);
          } else {
            api.reload('$2e929f', $2e929f);
          }
        }
...
},{"./KanbanCard":"src/components/KanbanCard.vue","_css_loader":"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/App.vue":[function(require,module,exports) {
"use strict";
  ...
  methods: {
    ...
    fetchData: function fetchData() {
      ...
      (0, _axios.default)({
        ...
        _this2.user.name = response.data.payload.name; // this.organizations = responsedata.payload.organization
        // for(let a = 0; this.status.length; a++){
    ...
    fetchAllOrganization: function fetchAllOrganization() {
      var _this3 = this;

      (0, _axios.default)({
        method: "GET",
        url: "".concat(this.baseUrl, "/organization"),
        headers: {
          access_token: localStorage.getItem("access_token")
        }
      }).then(function (response) {
        _this3.organizations = response.data.data;
      }).catch(function (err) {
        console.log(err);
      });
    }
...
exports.default = _default;
        var $00a1f7 = exports.default || module.exports;
      
      if (typeof $00a1f7 === 'function') {
        $00a1f7 = $00a1f7.options;
      }
    
        /* template */
        Object.assign($00a1f7, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _vm.currentPage === "register-page"
        ...
        ? _c("LoginPage", {
            on: { changePage: _vm.changePage, fetchData: _vm.fetchData }
          })
        ...
        ? _c(
            ...
            [
              ...
              _c("div", { staticClass: "header" }, [
                _c("h2", [_vm._v("Selamat Datang, " + _vm._s(_vm.user.name))])
              ]),
              _vm._v(" "),
              _c(
                "div",
                ...
                [
                  _c(
                    ...
                    {
                      staticClass:
                        "side-bar card-body col col-xl-3 border border-dark m-2 p-3"
                    },
                    [
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.newTodo.due_date,
                              expression: "newTodo.due_date"
                            }
                          ],
                          attrs: { type: "date" },
                          domProps: { value: _vm.newTodo.due_date },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$00a1f7', $00a1f7);
          } else {
            api.reload('$00a1f7', $00a1f7);
          }
        }
...
},{"axios":"node_modules/axios/index.js","./components/NavBar":"src/components/NavBar.vue","./components/LoginPage":"src/components/LoginPage.vue","./components/RegisterPage":"src/components/RegisterPage.vue","./components/KanbanBoard":"src/components/KanbanBoard.vue","_css_loader":"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
