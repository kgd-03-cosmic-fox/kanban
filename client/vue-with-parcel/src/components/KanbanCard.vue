<template>
  <div>
    <div v-for="elem in kondisi" :key="elem.id" class="card-body border p-3">
      ...
      <button v-if="status.id>0" @click="processTodo(elem.id,status.id-1)" class="btn btn-danger">Return</button><br><br>
  </div> 
</div>
</template>
